...
if World1 then
    ...
    MaterialMap = {
        ["Da + Sắt Vụn"] = "Leather + Scrap Metal",
        ["Cánh Thiên Thần"] = "Angel Wings",
        ["Quặng Dung Nham"] = "Magma Ore",
        ["Đuôi Cá"] = "Fish Tail",
    }
...
elseif World2 then
    ...
    MaterialMap = {
        ...
        ["Ngoại Chất"] = "Ectoplasm",
        ["Giọt Huyền Bí"] = "Mystic Droplet",
        ["Quặng Dung Nham"] = "Magma Ore",
        ["Nanh Ma Cà Rồng"] = "Vampire Fang",
    }
...
elseif World3 then
    ...
    MaterialMap = {
        ["Sắt Vụn"] = "Scrap Metal",
        ["Linh Hồn Quỷ"] = "Demonic Wisp",
        ["Ca Cao Ma Thuật"] = "Conjured Cocoa",
        ["Vảy Rồng"] = "Dragon Scale",
...
Farm:AddDropdown({
    ...
    Multi = false,
    Callback = function(I)
        getgenv().SelectMaterial = MaterialMap[I] or I
...
local z5 = {
    "Hộ Vệ",
    "Đại Lữ Đoàn Hải Tặc",
    "Đại Lữ Đoàn Hải Quân",
    "Lữ Đoàn Hải Tặc",
    "Lữ Đoàn Hải Quân",
    "Thuyền Buồm Hải Tặc",
    "Thuyền Buồm Hải Quân",
    "Thợ Săn Quái Thú",
}

local BoatMap = {
    ["Hộ Vệ"] = "Guardian",
    ["Đại Lữ Đoàn Hải Tặc"] = "PirateGrandBrigade",
    ["Đại Lữ Đoàn Hải Quân"] = "MarineGrandBrigade",
    ["Lữ Đoàn Hải Tặc"] = "PirateBrigade",
    ["Lữ Đoàn Hải Quân"] = "MarineBrigade",
    ["Thuyền Buồm Hải Tặc"] = "PirateSloop",
    ["Thuyền Buồm Hải Quân"] = "MarineSloop",
    ["Thợ Săn Quái Thú"] = "Beast Hunter",
}
...
Event:AddDropdown({
    ...
    Multi = false,
    Callback = function(I)
        _G.SelectedBoat = BoatMap[I] or I
    end,
})
...
Fruit:AddDropdown({
    ...
    Description = "",
    Options = e,
    Default = GetSetting("SelectChip_Save", "Flame"),
    Multi = false,
    Callback = function(I)
        _G.SelectChip = I
