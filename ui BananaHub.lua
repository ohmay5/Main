...
if getgenv().Nousigi then 
	if game.CoreGui:FindFirstChild("BaCon GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name,  "BaCon") then
				v:Destroy()
			end
		end
	end
...
Library_Function.Gui.Name = 'BaCon GUI'
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,80,80") .. ")\">" .. tostring(TitleNameMain or "BaCon") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Name or "Bacon hub"
   ...
   TextLabelMain.Text = "<font color=\"rgb(0,0,0)\">" .. tostring(TitleNameMain or "BaCon") .. "</font> <font color=\"rgb(255,255,255)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
	...
	local PageCounter = 1
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			local sectionFunction = {}
				...
				local Name = tostring(Setting.Name or "")
            ...
            function sectionFunction:AddDropdownSection(Setting)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    local TitleText = tostring(Setting.Name or "")
