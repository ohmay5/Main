...
["Color Hub 1"] = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 35, 35)),  -- đen nhạt
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(55, 55, 55)), -- xám đậm nhẹ (highlight rất dịu)
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(35, 35, 35))  -- đen nhạt
}),

["Color Hub 2"] = Color3.fromRGB(30, 30, 30),       -- nền chính đen nhạt (dùng cho stroke/border)

["Color Stroke"] = Color3.fromRGB(45, 45, 45),     -- viền xám tối (KHÔNG sáng)

["Color Theme"] = Color3.fromRGB(40, 40, 40),      -- màu theme xám đậm

["Color Text"] = Color3.fromRGB(200, 200, 200),    -- chữ xám sáng vừa, không chói

["Color Dark Text"] = Color3.fromRGB(140, 140, 140) -- chữ phụ xám tối hơn
        }
    },
	Info = {
		Version = "1.0"
...
function redzlib:SetTheme(NewTheme)
	...
	table.foreach(redzlib.Instances, function(_,Val)
		...
		elseif Val.Type == "Frame" then
			...
			Val.Instance.BackgroundTransparency = 0.45
...
function redzlib:MakeWindow(Configs)
	...
	local WMiniText = Configs[2] or Configs.SubTitle or "by : KW"
...
bg.Image = "rbxassetid://114476175638281"
...
local DropdownHolder = Create("Folder", ScreenGui, {
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "BaCon Hub",
			Text = "Do you want to close the script?",
			Options = {
				{"Yes", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			MinimizeButton.Image = "rbxassetid://114476175638281"
...
local Toggle = Create("Frame", Slider, {
    ...
    Position = UDim2.new(0, 0, 0.5),
    AnchorPoint = Vector2.new(0, 0.5),
    BackgroundColor3 = Color3.fromRGB(180, 0, 0),   -- ← MÀU CAM KHI BẬT
